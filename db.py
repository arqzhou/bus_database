...
def init_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS stops(t_id TEXT, st_date TEXT, fd_timestamp INTEGER, stop_id TEXT, arrival_time INTEGER, route_id TEXT, FOREIGN KEY (t_id, st_date, fd_timestamp) REFERENCES trips(trip_id, start_date, feed_timestamp))")
